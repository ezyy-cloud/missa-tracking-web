      ...
      <Grid xs={12} sm={8} md={8}>
        ...
        <Grid container xs={12}>
          <Grid container xs={12} sm={6} md={6} mt={6}>
            <Grid xs={3}>
              <Avatar sx={{ bgcolor: '#F5FE03', width: { xs: '60px', sm: '50', md: '80' }, height: { xs: '60px', sm: '50', md: '80' } }}>
                <CommuteIcon color="secondary" sx={{ fontSize: { xs: '40px', sm: '30', md: '40' } }} />
              </Avatar>
            </Grid>
            <Grid xs={9}>
              <Typography
          ...
          <Grid container xs={12} sm={6} md={6} mt={6}>
            <Grid xs={3}>
              <Avatar sx={{ bgcolor: '#F5FE03', width: { xs: '60px', sm: '50', md: '80' }, height: { xs: '60px', sm: '50', md: '80' } }}>
                <CalendarViewWeekIcon color="secondary" sx={{ fontSize: 40 }} />
              </Avatar>
            </Grid>
            <Grid xs={9}>
              <Typography
          ...
          <Grid container xs={12} sm={6} md={6} mt={6}>
            <Grid xs={3}>
              <Avatar sx={{ bgcolor: '#F5FE03', width: { xs: '60px', sm: '50', md: '80' }, height: { xs: '60px', sm: '50', md: '80' } }}>
                <DevicesOtherIcon color="secondary" sx={{ fontSize: 40 }} />
              </Avatar>
            </Grid>
            <Grid xs={9}>
              <Typography
